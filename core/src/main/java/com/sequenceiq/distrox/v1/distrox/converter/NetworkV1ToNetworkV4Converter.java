...
import static com.sequenceiq.cloudbreak.util.ConditionBasedEvaulatorUtil.evaluateIfTrue;
...
public class NetworkV1ToNetworkV4Converter {
    ...
    private MockNetworkV4Parameters getMockNetworkParameters(Optional<MockNetworkV1Parameters> mock, EnvironmentNetworkResponse value) {
        ...
        return getIfNotNull(new ImmutablePair<>(params, value), this::convertToMockNetworkParams);
    }
    ...
    private MockNetworkV4Parameters convertToMockNetworkParams(Pair<MockNetworkV1Parameters, EnvironmentNetworkResponse> source) {
        ...
        if (key != null) {
            ...
            evaluateIfTrue(subnetId, StringUtils::isNotEmpty, params::setSubnetId, s -> params.setSubnetId(getFirstSubnetIdFromEnvironment(value)));
