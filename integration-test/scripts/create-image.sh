...
if [[ "$VERSION" ]]; then
docker pull hortonworks/cloudbreak:$VERSION
docker tag hortonworks/cloudbreak:$VERSION hortonworks/cloudbreak:dev
else
...
if [[ "$VERSION" ]]; then
docker pull hortonworks/cloudbreak-autoscale:$VERSION
docker tag hortonworks/cloudbreak-autoscale:$VERSION hortonworks/cloudbreak-autoscale:dev
else
...
if [[ "$VERSION" ]]; then
docker pull hortonworks/cloudbreak-datalake:$VERSION
docker tag hortonworks/cloudbreak-datalake:$VERSION hortonworks/cloudbreak-datalake:dev
else
...
if [[ "$VERSION" ]]; then
docker pull hortonworks/cloudbreak-freeipa:$VERSION
docker tag hortonworks/cloudbreak-freeipa:$VERSION hortonworks/cloudbreak-freeipa:dev
else
...
if [[ "$VERSION" ]]; then
docker pull hortonworks/cloudbreak-environment:$VERSION
docker tag hortonworks/cloudbreak-environment:$VERSION hortonworks/cloudbreak-environment:dev
else
...
if [[ "$VERSION" ]]; then
docker pull hortonworks/cloudbreak-redbeams:$VERSION
docker tag hortonworks/cloudbreak-redbeams:$VERSION hortonworks/cloudbreak-redbeams:dev
else
